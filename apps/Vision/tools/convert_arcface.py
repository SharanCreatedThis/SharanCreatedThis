...
backbone trained with ArcFace loss) into a Core ML .mlpackage that Vision's
...
Output:
    vision/Models/ArcFace.mlpackage
...
DEFAULT_OUTPUT = REPO_ROOT / "vision" / "Models" / "ArcFace.mlpackage"
...
def main() -> None:
    ...
    print("Next: add this file to the Xcode project (vision/Models/ArcFace.mlpackage) if not auto-picked-up,")
