...
//  vision
//
//  Enforces `VisionSettings.autoLockInterval`: re-locks the session once idle past the user's chosen limit.
//
...
final class SessionAutoLocker {
    ...
    func evaluate() {
        ...
        let idleLimit = VisionSettings.shared.autoLockInterval.duration
