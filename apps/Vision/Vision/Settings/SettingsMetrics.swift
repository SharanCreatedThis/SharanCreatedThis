...
enum SettingsMetrics {
    static let windowSize = CGSize(width: 740, height: 780)
    ...
    static let pageTitleFont = Font.system(size: 24, weight: .bold, design: .rounded)
    ...
    static let statFont = Font.system(size: 28, weight: .bold, design: .rounded)
    ...
    static let cardBorderColor = adaptiveColor(
