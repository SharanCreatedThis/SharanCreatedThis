...
final class VisionSettings {
    ...
    private enum Key {
        static let isFaceUnlockEnabled = "VisionSettings.isFaceUnlockEnabled"
        static let matchThreshold = "VisionSettings.matchThreshold"
        static let livenessChecksEnabled = "VisionSettings.livenessChecksEnabled"
        static let livenessMode = "VisionSettings.livenessMode"
        static let minimumFaceWidth = "VisionSettings.minimumFaceWidth"
        static let unlockAnimationStyle = "VisionSettings.unlockAnimationStyle"
        static let showUnlockAnimation = "VisionSettings.showUnlockAnimation"
        /// Legacy bool key — read once during migration, then ignored.
        static let playUnlockAnimation = "VisionSettings.playUnlockAnimation"
        static let unlockTriggers = "VisionSettings.unlockTriggers"
        static let retryOnHover = "VisionSettings.retryOnHover"
        static let faceDetectionSeconds = "VisionSettings.faceDetectionSeconds"
        static let autoRetryOnce = "VisionSettings.autoRetryOnce"
        static let hapticFeedbackEnabled = "VisionSettings.hapticFeedbackEnabled"
        static let preferredDisplayID = "VisionSettings.preferredDisplayID"
        static let preferredDisplayName = "VisionSettings.preferredDisplayName"
        static let autoLockIntervalDays = "VisionSettings.autoLockIntervalDays"
        static let defaultCameraID = "VisionSettings.defaultCameraID"
        static let builtInDisplayCameraID = "VisionSettings.builtInDisplayCameraID"
        static let externalDisplayCameraID = "VisionSettings.externalDisplayCameraID"
        static let hasCompletedOnboarding = "VisionSettings.hasCompletedOnboarding"
        static let onboardingResumeStep = "VisionSettings.onboardingResumeStep"
        static let hasAcknowledgedSecurityNotice = "VisionSettings.hasAcknowledgedSecurityNotice"
        static let isGuardEnabled = "VisionSettings.isGuardEnabled"
        static let isVaultEnabled = "VisionSettings.isVaultEnabled"
        static let hasSeenWelcome = "VisionSettings.hasSeenWelcome"
        static let lastAppVersion = "VisionSettings.lastAppVersion"
        static let hasShownFirstUnlockCelebration = "VisionSettings.hasShownFirstUnlockCelebration"
        static let hasShownMilestonePopup = "VisionSettings.hasShownMilestonePopup"
        static let automaticallyDownloadsUpdates = "VisionSettings.automaticallyDownloadsUpdates"
    }
    ...
    var isGuardEnabled: Bool {
        didSet {
            defaults.set(isGuardEnabled, forKey: Key.isGuardEnabled)
            VisionAnalytics.shared.track(.visionGuardEnabled, properties: ["enabled": isGuardEnabled])
        }
    }
    var isVaultEnabled: Bool {
        didSet {
            defaults.set(isVaultEnabled, forKey: Key.isVaultEnabled)
            VisionAnalytics.shared.track(.visionVaultEnabled, properties: ["enabled": isVaultEnabled])
        }
    }

    var isFaceUnlockEnabled: Bool {
        didSet {
            defaults.set(isFaceUnlockEnabled, forKey: Key.isFaceUnlockEnabled)
            VisionAnalytics.shared.track(.visionUnlockEnabled, properties: ["enabled": isFaceUnlockEnabled])
        }
    }
    ...
    var lastAppVersion: String? {
        didSet { defaults.set(lastAppVersion, forKey: Key.lastAppVersion) }
    }
    var hasShownFirstUnlockCelebration: Bool {
        didSet { defaults.set(hasShownFirstUnlockCelebration, forKey: Key.hasShownFirstUnlockCelebration) }
    }
    var hasShownMilestonePopup: Bool {
        didSet { defaults.set(hasShownMilestonePopup, forKey: Key.hasShownMilestonePopup) }
    }
    var automaticallyDownloadsUpdates: Bool {
        didSet { defaults.set(automaticallyDownloadsUpdates, forKey: Key.automaticallyDownloadsUpdates) }
    }
    ...
    private init() {
        ...
        isGuardEnabled = defaults.object(forKey: Key.isGuardEnabled) as? Bool ?? true
        isVaultEnabled = defaults.object(forKey: Key.isVaultEnabled) as? Bool ?? true
        hasSeenWelcome = defaults.bool(forKey: Key.hasSeenWelcome)
        lastAppVersion = defaults.string(forKey: Key.lastAppVersion)
        hasShownFirstUnlockCelebration = defaults.bool(forKey: Key.hasShownFirstUnlockCelebration)
        hasShownMilestonePopup = defaults.bool(forKey: Key.hasShownMilestonePopup)
        automaticallyDownloadsUpdates = defaults.object(forKey: Key.automaticallyDownloadsUpdates) as? Bool ?? false
