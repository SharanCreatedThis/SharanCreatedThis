    ...
    private func layers(length: CGFloat) -> some View {
        ZStack {
            streakLayer(
                ...
                colors: [VisionTheme.accent, VisionTheme.accentBright]
            )
            streakLayer(
                length: length,
                ...
                colors: spec.isVivid
                    ? [VisionTheme.accentBright, VisionTheme.accentPale]
                    : [VisionTheme.accent, VisionTheme.accentBright]
            )
            streakLayer(
                length: length,
                ...
                colors: [VisionTheme.accentBright, VisionTheme.accentPale]
            )
            if spec.hasHighlight {
                streakLayer(
                    ...
                    colors: [VisionTheme.accentPale, Color.white]
                )
            }
        }
        .compositingGroup()
