...
enum ArcFaceEmbedderError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .modelNotFound:
            return "ArcFace.mlpackage/mlmodelc not found in the app bundle. Run tools/convert_arcface.py, then add vision/Models/ArcFace.mlpackage to the Xcode project."
