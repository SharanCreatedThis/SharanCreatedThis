...
enum CollectionCharmCatalog {
    ...
    /// The hand-drawn collection, the seasonal packs, then the four collections.
    static let entries: [Entry] = collectionEntries + seasonalEntries + collectionPackEntries
