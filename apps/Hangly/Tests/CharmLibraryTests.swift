...
struct CharmLibraryViewModelTests {
    ...
    func selectionSwitchesTheRope() throws {
        ...
        // The place being dressed is the bottom one by default, which is what every
        // part of the app that predates places means by "the charm".
        #expect(fixture.manager.selection == .builtIn(.scarab))
        #expect(fixture.viewModel.isOnRope(.builtIn(.scarab)))
    ...
    func importsAppearUnderYours() async throws {
        ...
        // The view watches for this; a charm that has just been made is the one the
        // person who made it is looking for.
        fixture.viewModel.adoptNewImports()
