...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", siteName: SITE_NAME, locale: "en_IN", url: absoluteUrl("/compare"),
    title: TITLE, description: DESCRIPTION, images: [{ url: "/og/compare.png", width: 1200, height: 630, alt: TITLE }] },
  twitter: { card: "summary_large_image", title: TITLE, description: DESCRIPTION, images: ["/og/compare.png"] },
};
