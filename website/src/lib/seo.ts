...
export const PAGES: Record<PageKey, PageSeo> = {
  ...
  hangly: {
    ...
    description:
      "Hang beautiful digital charms with real swinging physics on your Mac or Windows desktop. 75 charms across 11 collections. Free for macOS 14+ and Windows 10+.",
    image: "/og/hangly.png",
