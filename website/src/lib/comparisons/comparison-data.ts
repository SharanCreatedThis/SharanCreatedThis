...
export const COMPARISONS: Comparison[] = [
  {
    ...
    description:
      "Both hang a lucky charm from the top of your screen on Mac and Windows. Hangly adds custom charms from your photos, eleven collections and three cord styles, free.",
    h1: "Hangly vs Lucky Dangle",
    verdict:
      "The closest comparison in this list. Both hang a charm on a cord from the top of the screen, on Mac and Windows, and both stay out of every click. Hangly's advantage is breadth: charms made from your own images, eleven themed collections, and adjustable cords and sizing.",
    whatIsIt:
    ...
    customisation:
      "This is the clearest difference. Hangly ships over thirty charms across eleven collections, three cord styles, adjustable sizing, multiple charms at once and multi-monitor placement — plus the ability to turn any image into a charm. Lucky Dangle presents a curated set without publishing a count.",
    privacy:
    ...
    hanglyWins: [
      ...
      "Over thirty charms across eleven collections",
    ...
    answers: [
      ...
      },
      {
        ...
        answer:
          "Hangly, clearly. Over thirty charms across eleven collections, three cord styles, adjustable sizing, several charms at once, multi-monitor placement, and any image as a charm. Lucky Dangle publishes no comparable list.",
        points: [
          "Hangly: 30+ charms, 11 collections, custom images, 3 cords, size control",
  ...
  },
  {
    ...
    answers: [
      ...
      },
      {
        question: "Which has more customisation?",
        answer:
          "Screen Dangle, if customisation means configuring one charm in depth. Hangly, if it means variety of finished charms — eleven collections, over thirty designs, three cord styles — plus your own images.",
      },
      {
        question: "Which is best for desktop charms specifically?",
        answer:
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Hangly ships over thirty across eleven named collections. Screen Dangle emphasises building your own rather than publishing a count.",
      },
      {
  ...
  },
  {
    ...
    rows: [
      ...
      { feature: "Published charm count", hangly: "30+ across 11 collections", rival: "Not published" },
    ...
    customisation:
      "Hangly publishes what it offers: over thirty charms, eleven collections, three cords, size control, several charms at once, and any image as a charm. DangleJoy describes cultural icons and lucky symbols without a published count.",
    privacy:
    ...
    answers: [
      ...
      },
      {
        question: "Which has more customisation?",
        answer:
          "Hangly publishes more: eleven collections, over thirty charms, three cord styles, size control and custom images. DangleJoy does not publish a comparable list.",
      },
      {
  ...
  },
  {
    ...
    verdict:
      "Near-identical in concept — a charm on a cord with real pendulum physics that stays out of your clicks. Hangly's difference is reach: Windows including native ARM64, eleven collections, and your own images as charms.",
    whatIsIt:
    ...
    howHanglyDiffers:
      "The core idea is the same, down to the pendulum physics. Hangly adds platform reach — Windows 10+ on x64 and native ARM64 — plus eleven named collections, custom charms from your own images, three cord styles and adjustable sizing.",
    rows: [
      { feature: "macOS", hangly: "14+, Apple Silicon & Intel", rival: "Yes" },
    ...
    customisation:
      "Hangly ships more of it: eleven collections, over thirty charms, three cords, adjustable size and any image as a charm. Charmly presents a focused charm set.",
    privacy:
    ...
    answers: [
      ...
      },
      {
        question: "Which has more customisation?",
        answer:
          "Hangly: eleven collections, over thirty charms, three cord styles, adjustable size and custom images from your own files.",
      },
      {
  ...
  },
  {
    ...
    rows: [
      ...
      { feature: "Customisation", hangly: "30+ charms, your own images", rival: "A goose" },
    ...
    customisation:
      "Desktop Goose has mods and alternate assets from its community, but the concept is one goose. Hangly ships over thirty charms across eleven collections, three cord styles, adjustable sizing and any image as a charm.",
    privacy:
    ...
    answers: [
      ...
      },
      {
        question: "Which has more customisation?",
        answer:
          "Hangly, by design — over thirty charms, eleven collections, three cords, adjustable size and any image. Desktop Goose has community mods, but the concept remains one goose.",
      },
      {
        question: "Which is best for desktop charms specifically?",
        answer:
  ...
  },
  {
    ...
    rows: [
      ...
      { feature: "Customisation", hangly: "30+ charms, your own images", rival: "Many runner characters" },
      { feature: "Price", hangly: "Free", rival: "Free" },
    ],
    performance:
    ...
    customisation:
      "RunCat offers many runner characters within a fixed menu bar slot. Hangly offers over thirty charms, eleven collections, three cord styles, adjustable size and any image. Different axes.",
    privacy:
    ...
    answers: [
      ...
      },
      {
        question: "Which has more customisation?",
        answer:
          "Different axes. RunCat offers many runner characters inside one menu bar slot. Hangly offers over thirty charms, three cords, adjustable size and any image, hanging anywhere along the screen top.",
      },
      {
        question: "Which is best for desktop charms specifically?",
  ...
  },
  {
    ...
    rows: [
      ...
      { feature: "Ready-made designs", hangly: "30+ across 11 collections", rival: "Generated from your photo" },
    ],
    performance:
    ...
    customisation:
      "Dockling generates a pet from a photo, which is its whole customisation model. Hangly does that too and adds eleven collections of finished charms, three cord styles and size control.",
    privacy:
    ...
    answers: [
      ...
      },
      {
        question: "Which has more customisation?",
        answer:
          "Hangly ships more ready-made variety — eleven collections, over thirty charms, three cords, size control — and accepts your own images too. Dockling's model is a pet generated from one photo.",
      },
      {
        question: "Which is best for desktop charms specifically?",
        answer:
