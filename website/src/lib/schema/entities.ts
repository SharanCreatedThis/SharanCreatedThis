...
export const HANGLY_APP: AppFacts = {
  ...
  name: "Hangly",
  description:
    "A free desktop app for macOS and Windows that hangs a decorative charm from the top of your screen on a cord with real pendulum physics. Over thirty charms across eleven collections, plus any image of your own.",
