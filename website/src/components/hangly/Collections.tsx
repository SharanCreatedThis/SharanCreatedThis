...
export const collections = [
  ...
  },
  {
    ...
    className: "football",
    charms: [
      ["football25", "Football charm 1"],
      ["football26", "Football charm 2"],
      ["football27", "Football charm 3"],
      ["football28", "Football charm 4"],
      ["football29", "Football charm 5"],
    ],
  },
  {
    ...
    charms: [
      ["strangerThings8", "Stranger Things charm 1"],
      ["strangerThings9", "Stranger Things charm 2"],
      ["strangerThings10", "Stranger Things charm 3"],
      ["strangerThings11", "Stranger Things charm 4"],
      ["strangerThings12", "Stranger Things charm 5"],
      ["strangerThings13", "Stranger Things charm 6"],
    ],
  },
  {
    name: "Singers",
    ...
    className: "singers",
    charms: [
      ["singer20", "Singer charm 1"],
      ["singer21", "Singer charm 2"],
      ["singer22", "Singer charm 3"],
      ["singer23", "Singer charm 4"],
      ["singer24", "Singer charm 5"],
    ],
  },
  {
    name: "Breaking Bad",
    ...
    charms: [
      ["breakingBad1", "Breaking Bad charm 1"],
      ["breakingBad2", "Breaking Bad charm 2"],
      ["breakingBad3", "Breaking Bad charm 3"],
      ["breakingBad4", "Breaking Bad charm 4"],
      ["breakingBad5", "Breaking Bad charm 5"],
      ["breakingBad6", "Breaking Bad charm 6"],
      ["breakingBad7", "Breaking Bad charm 7"],
    ],
  },
  {
    name: "Friends",
    ...
    className: "friends",
    charms: [
      ["friends14", "Friends charm 1"],
      ["friends15", "Friends charm 2"],
      ["friends16", "Friends charm 3"],
      ["friends17", "Friends charm 4"],
      ["friends18", "Friends charm 5"],
      ["friends19", "Friends charm 6"],
    ],
  },
  {
    name: "Dream Catcher",
