...
const stats=[{icon:Waves,value:'Thousands',label:'of happy little swings'},{icon:Shapes,value:'80+',label:'charms. Endless personality.'},{icon:Orbit,value:'Your style',label:'multiple ropes to make it yours'},{icon:Feather,value:'Light as air',label:'a tiny menu bar companion'}];
